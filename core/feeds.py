...
from moronweb.core import models
...
class OrdenesDeCompraFeed(Feed):
    ...
    def title(self):
        return "Gasto Público Moronense: Últimas órdenes de compra"

    def description(self):
        description = "Últimas órdenes de compra publicadas por la Municipalidad de Morón"
